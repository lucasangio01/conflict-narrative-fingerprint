...
class EmbedText:
    def __init__(self, website):
        ...
        if website in Websites.WEBSITES_PALESTINE_ISRAEL:
            self.filters = Embedding.FILTERS_UKRAINE_RUSSIA
            ...
            self.filters = Embedding.FILTERS_PALESTINE_ISRAEL
    ...
    def create_embeddings(self):
        ...
        filter_embeddings = Embedding.SENTENCE_EMBEDDER.encode(self.filters, normalize_embeddings=True).reshape(3, 384)
        text_embeddings = Embedding.SENTENCE_EMBEDDER.encode(self.df_chunked["text"].tolist(), show_progress_bar = True, normalize_embeddings = True)
